> **Historical document**: This is an execution log from the Phase 1 implementation. For current architecture, see [ARCHITECTURE.md](../architecture/ARCHITECTURE.md).
