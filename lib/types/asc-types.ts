/**
 * Shared type declarations for platform APIs
 *
 * These types are used by both browser and Electron environments.
 * The actual implementation differs by platform.
 */
